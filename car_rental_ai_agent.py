...
Duty Type ,"Package format like G-04HR 40KMS or P-08HR 80KMS","Must contain exact package format based on corporate (G2G/P2P) + keywords detection. Examples: G-04HR 40KMS (G2G airport drop), P-08HR 80KMS (P2P local disposal), G-Outstation 250KMS (G2G outstation major cities), P-Outstation 300KMS (P2P outstation Kolkata/others).",,,

        ...
        try:
            ...
            for booking in bookings_list:
                booking_dict = {
                    ...
                    'drop1': getattr(booking, 'drop1', None),
                    'drop2': getattr(booking, 'drop2', None),
                    'drop3': getattr(booking, 'drop3', None),
                    'drop4': getattr(booking, 'drop4', None),
                    'drop5': getattr(booking, 'drop5', None),
                    'vehicle_group': booking.vehicle_group,
                    'duty_type': booking.duty_type,
                    'corporate_duty_type': getattr(booking, 'corporate_duty_type', None),
                    'recommended_package': getattr(booking, 'recommended_package', None),
                    'approval_required': getattr(booking, 'approval_required', None),
                    ...
                    'drop_address': booking.drop_address,  # Keep for backward compatibility
